...
function Checkout() {
    ...
    return(
        <div className='infoSection column'>
            <form>
            ...
            <svg className="lineaCheckoutMobile" width="400" height="1" viewBox="0 0 500 1" fill="none" xmlns="http://www.w3.org/2000/svg">
                <line y1="0.5" x2="500" y2="0.5" stroke="#9C9C9C"/>
            </svg>
